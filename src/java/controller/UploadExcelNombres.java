 ...
 * @author pcc
 */
public class UploadExcelNombres extends HttpServlet {
    ...
    public void subirFichero(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, FileUploadException {
        ...
        while (iter.hasNext()) {
            ...
            if (!item.isFormField()) {
              ...
              if (fileName.equals("Nombresconta.xlsx")){
            ReadFileNombres.LeerArchivoNombre(new FileInputStream(uploadedFile));
        System.out.println ("si");
                }if (fileName.equals("Especialidad.xlsx")){
